class HirezApiMethods:
    ...
    GET_DEMO_DETAILS = "/getdemodetails[ResponseFormat]/{developerId}/{signature}/{session}/{timestamp}/{match_id}"
    GET_MATCH_DETAILS = "/getmatchdetails[ResponseFormat]/{developerId}/{signature}/{session}/{timestamp}/{match_id}"
    GET_MATCH_DETAILS_BATCH = "/getmatchdetailsbatch[ResponseFormat]/{developerId}/{signature}/{session}/{timestamp}/{match_idList}"
    GET_MATCH_IDS_BY_QUEUE = "/getmatchidsbyqueue[ResponseFormat]/{developerId}/{signature}/{session}/{timestamp}/{queue}/{date}/{hour}"
    GET_MATCH_PLAYER_DETAILS = "/getmatchplayerdetails[ResponseFormat]/{developerId}/{signature}/{session}/{timestamp}/{match_id}"
